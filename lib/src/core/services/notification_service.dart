...
class NotificationService {
  ...
  Future<void> init() async {
    ...
    if (Platform.isAndroid) {
      final androidImplementation = flutterLocalNotificationsPlugin // Fixed name
    ...
    await flutterLocalNotificationsPlugin.initialize( // Fixed name
  ...
  Future<void> showInstantNotification({
    ...
    await flutterLocalNotificationsPlugin.show( // Fixed name
      id,
      title,
      body,
  ...
  Future<void> scheduleNotification({
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule( // Fixed name
      id,
      title,
      body,
