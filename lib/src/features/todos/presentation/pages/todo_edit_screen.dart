...
class TodoFormState {
  ...
  TodoFormState(this.task, this.category, this.date, this.hasReminder, this.isDone);
  ...
  @override
  int get hashCode => Object.hash(task, category, date, hasReminder, isDone);
}
...
class _TodoEditScreenState extends State<TodoEditScreen> {
  ...
  void initState() {
    ...
    _categoryController = TextEditingController(text: widget.todo?.category ?? 'General');
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Select Date & Time', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                    TextButton(
                      onPressed: () {
                        setState(() {
                ...
                child: CupertinoTheme(
                  data: CupertinoThemeData(
                    ...
                    textTheme: CupertinoTextThemeData(
                      dateTimePickerTextStyle: theme.textTheme.bodyLarge?.copyWith(fontSize: 18),
                    ),
                  ),
      ...
      child: GlassScaffold(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(Icons.undo, color: _undoStack.length > 1 ? colorScheme.onSurface : colorScheme.onSurface.withOpacity(0.3)),
            tooltip: 'Undo',
          ),
          IconButton(
            onPressed: _redoStack.isNotEmpty ? _redo : null,
            icon: Icon(Icons.redo, color: _redoStack.isNotEmpty ? colorScheme.onSurface : colorScheme.onSurface.withOpacity(0.3)),
            tooltip: 'Redo',
          ),
          if (widget.todo != null)
            IconButton(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Category', style: textTheme.bodySmall?.copyWith(color: colorScheme.primary.withOpacity(0.8), fontSize: 14)),
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: Icon(_isDropdownOpen ? Icons.arrow_drop_up : Icons.arrow_drop_down, color: colorScheme.onSurface.withOpacity(0.54)),
                          onPressed: () {
                            if(_isDropdownOpen) {
                              _categoryFocusNode.unfocus();
                            } else {
                        ...
                        hintStyle: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface.withOpacity(0.3)),
                      ),
                    ),
                  ),
                ),
              ...
              Text('What needs to be done?', style: textTheme.bodySmall?.copyWith(color: colorScheme.primary.withOpacity(0.8), fontSize: 14)),
              const SizedBox(height: 8),
              Hero(
              ...
              GlassContainer(
                ...
                child: Row(
                  children: [
                    Icon(Icons.calendar_month, color: _selectedDate == null ? colorScheme.onSurface.withOpacity(0.54) : colorScheme.error),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            dateText,
                            style: TextStyle(
                                color: _selectedDate == null ? colorScheme.onSurface.withOpacity(0.38) : colorScheme.error,
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      color: _isDone ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.54),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          color: _isDone ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.7),
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text('Save Task', style: TextStyle(color: colorScheme.onPrimary, fontWeight: FontWeight.bold)),
